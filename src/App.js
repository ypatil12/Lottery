...
class App extends Component {
  ...
  async componentDidMount() {
    //Dont have to say from because default metamask from the first
  ...
  onSubmit = async (event) =>{
    //Prevents default action of event from happening
  ...
  render() {
    return (
      <div>
        ...
        <p>There are currently {this.state.players.length} players entered
